...
# From version 0.9.12 by BadButton www.wotnumbers.com #
#######################################################
...
def main():
    ...
    dossierheader['parser'] = 'http://www.wotnumbers.com'
...
def load_structures():
    ...
    load_versions = [10,17,18,20,22,24,26,27,28,29,65,69,77,81,85,87,88,89,92,94,95,96,97,98,99,100,101];
